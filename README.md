...
**`Grpc.Core.RpcException` ou `DeadlineExceeded` durante a instalação.** O serviço do WireSock não está respondendo. Acontece logo depois de instalar ou consertar o .NET: o serviço ficou de pé com o runtime antigo. **Reinicie o computador** e rode o instalador de novo.
